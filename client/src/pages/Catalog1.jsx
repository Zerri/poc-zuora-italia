...
function CatalogPage() {
  ...
  // Funzione per gestire l'aggiunta all'offerta
  const handleAddToOffer = (data) => {
    // Qui la logica per aggiungere il prodotto all'offerta
    console.log('Prodotto aggiunto all\'offerta:', data);
    // Eventualmente navigare alla pagina dell'offerta o mostrare un messaggio di conferma
  };
